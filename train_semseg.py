...
def main(args):
    ...
    TRAIN_DATASET = CustomPointDataset(split='train', data_root=root, num_point=NUM_POINT, test_range=(241, 300), block_size=1.0, sample_rate=1.0, transform=None)
    ...
    # Model giriş boyutu 3 olmalı (xyz)
